...
(
    ...
    `rating_level` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '漏洞级别',
    ...
    `vul_type`     varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '漏洞类型 threat_category',
    `cve_id`       varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci  NULL DEFAULT NULL,
    `cnvd_id`      varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci  NULL DEFAULT NULL
) ENGINE = MyISAM
  CHARACTER SET = utf8
